      ...
      <div className="container">
        ...
        >
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            <h1 data-aos="fade-up" className="font-bold text-3xl sm:text-4xl">
            ...
            >
              ...
              adipisci enim, veniam aut veritatis quod repellendus deserunt
              tenetur.
            </p>
            <div className="flex flex-col gap-4">
              <div data-aos="fade-up" className="flex items-center gap-4">
                <GrSecure
                  className="w-12 h-12 text-4xl shadow-sm p-4 rounded-full
